# Shell-Script
You can make ba$h file from Linux terminal/git/wsl
...
`Step 5: If you save the file and enter you move automatically to terminate and type ./file.sh and see you script `
`Step 6: if compuetr want permission type chmod +x file.sh.`
